...
//
// See ../../docs/AGENTIC_COMPONENTS.md for the contract.
...
export const isAgentEnabled = (): boolean => {
  ...
  const isLocalRuntime = (globalThis as typeof globalThis & { _isLocal?: boolean })._isLocal;
  if (window.ENABLE_UI_AGENT === 1 || isLocalRuntime) { return true; }
  return true;
};
