import type { Style } from 'excelize-wasm';
import type {
  ExcelColumnConfig,
  ExcelTableColumn,
  HeaderCellLayout,
...
import type { ExcelRuntime, ExcelizeModule } from './runtime.js';
...
export function resolveHeaderText<T>(runtime: ExcelRuntime, column: ExcelTableColumn<T>): string {
	const header = column.excel?.header
		? column.excel.header
		: typeof column.header === 'function' ? column.header() : column.header
	return runtime.translate(header)
}
