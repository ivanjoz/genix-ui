...
"use-strict"
import { parseObject } from '../cache/index.js'
...
self.addEventListener('fetch', (event) => {
	...
	// Skip /webpage-app routes (handled by store app service worker)
...
// Re-export the package helper for worker diagnostics without coupling cache code to this shell.
export { parseObject }
